...
public class MissingReferencesFinder : MonoBehaviour {
    ...
    public static void MissingSpritesInAssets() {
        ...
        GameObject[] objs = allAssets.Select(a => AssetDatabase.LoadAssetAtPath(a, typeof(GameObject)) as GameObject).Where(a => a != null).ToArray();
    ...
    private static void ShowError(string context, GameObject go, string componentName, string propertyName) {
        string ERROR_TEMPLATE = "Missing Ref in: [{3}]{0}. Component: {1}, Property: {2}";
